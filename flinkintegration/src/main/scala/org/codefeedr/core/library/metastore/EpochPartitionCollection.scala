...
trait EpochPartitionCollection
    extends ZkCollectionStateNode[EpochPartition, Unit, Partition, Boolean, Boolean]

trait EpochPartitionCollectionComponent extends ZkCollectionStateNodeComponent {
  this: ZkClientComponent with EpochPartitionComponent =>
