...
class GhtorrentSpec extends FlatSpec {
  ...
  "User" should "be be able to serialize and deserialze" in {
    val user = User(
      ...
      state = None,
      city = Some("city"),
      updated_at = DateTime.now(DateTimeZone.UTC),
